...
def inject_css(theme: str) -> dict:
    ...
    .stTabs [data-baseweb="tab-list"] {{ gap:6px; border-bottom:1px solid rgba(14,165,233,.35); }}
    .stTabs [data-baseweb="tab"] {{ padding:6px 14px; border-radius:8px 8px 0 0; cursor:pointer; }}
    .stTabs [data-baseweb="tab"]:hover {{ background:rgba(14,165,233,.14); }}
    .stTabs [aria-selected="true"] {{ background:rgba(14,165,233,.18); }}
